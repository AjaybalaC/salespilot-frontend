...
export default function TextArea({ label, error, className, id: externalId, ...props }: Props) {
  ...
  return (
    <div className="space-y-1.5">
      ...
      <textarea
        ...
        className={clsx(
          "w-full resize-y rounded-lg border px-3 py-2.5 text-sm outline-none transition-all",
